...
const PurchasePage = () => {
  ...
  return (
    ...
    <div className="p-4 sm:ml-64">
      ...
      <label htmlFor="plans" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
        Select plan
      </label>
      <select
        id="plans"
      ...
      {selectedPlan === 'ipv6-unlimited' && (
        <div>
          <label htmlFor="speed" className="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
            Select Days 
          </label>
          <select 
     ...
     <div>
        <label htmlFor="bandwidth" className="block mt-4 mb-2 text-sm font-medium text-gray-900 dark:text-white">
        Select Bandwidth
        </label>
        <select 
